...
public final class SenderReceiverInitializer1 extends ModelInitializer {
	...
	public SenderReceiverInitializer1(Model model, SenderReceiverMetaModel metaModel) {
		super(model);
