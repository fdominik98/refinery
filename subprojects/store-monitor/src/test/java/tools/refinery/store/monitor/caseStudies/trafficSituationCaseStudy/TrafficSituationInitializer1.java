...
public final class TrafficSituationInitializer1 extends ModelInitializer {
	...
	public TrafficSituationInitializer1(Model model, TrafficSituationMetaModel metaModel) {
		super(model);
		grid = new Tuple[2][10];
