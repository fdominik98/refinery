...
public final class TrafficSituationInitializer3 extends ModelInitializer {
	public final Tuple[][] grid;
	public final Tuple actor1;
	public final Tuple actor2;
	public final Tuple actor3;
	public final Tuple actor4;
	public final Tuple actor5;
	...
	public TrafficSituationInitializer3(Model model, TrafficSituationMetaModel metaModel) {
		super(model);
		grid = new Tuple[6][30];
		...
		actor4 = modificationAdapter.createObject();
		actor5 = modificationAdapter.createObject();
		...
		carInterpretation.put(actor4, true);
		actorInterpretation.put(actor4, true);
		onCellInterpretation.put(Tuple.of(actor4.get(0), grid[0][7].get(0)), true);
		carInterpretation.put(actor5, true);
		actorInterpretation.put(actor5, true);
		onCellInterpretation.put(Tuple.of(actor5.get(0), grid[5][7].get(0)), true);
	}
