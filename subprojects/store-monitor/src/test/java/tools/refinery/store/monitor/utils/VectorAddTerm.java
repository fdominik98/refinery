...
public class VectorAddTerm extends BinaryTerm<Vector, Vector, Vector> {
	protected VectorAddTerm(Term<Vector> left, Term<Vector> right) {
	...
	public Term<Vector> doSubstitute(Substitution substitution, Term<Vector> substitutedLeft,
		...
		return new VectorAddTerm(substitutedLeft, substitutedRight);
	}
